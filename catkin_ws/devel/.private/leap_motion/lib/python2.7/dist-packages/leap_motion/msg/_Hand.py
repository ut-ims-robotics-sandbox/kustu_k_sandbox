...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.palm_velocity))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.sphere_center))
      _x = self.to_string
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.arm.center))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.palm_velocity = s.unpack(str[start:end])
      _x = self
      start = end
      end += 32
      ...
      self.sphere_center = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.arm.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.arm.center = s.unpack(str[start:end])
      _x = self
      start = end
      end += 24
